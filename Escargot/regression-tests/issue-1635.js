...
assert(throughObjectMethod.read(p) === 'px');
assert(throughObjectMethod.write(p, 'updated') === 'updated');
assert(throughObjectMethod.read(p) === 'updated');
